    ...
    private ManeuverImage maneuverImage(Instruction instruction) {
        ...
        switch (instruction.getType()) {
            ...
            case FORK:
                ...
                break;
            case ROUNDABOUT:
                maneuverImage = maneuverImageFromRoundabout(instruction.getRoundabout(), instruction.getDrivingSide());
                break;
            case EXIT_ROUNDABOUT:
                maneuverImage = maneuverImageFromRoundabout(instruction.getExitRoundabout().getRoundabout(), instruction.getDrivingSide());
                break;
            case EXIT:
