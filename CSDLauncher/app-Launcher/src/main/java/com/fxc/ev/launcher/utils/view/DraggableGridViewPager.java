...
public class DraggableGridViewPager extends ViewGroup {
    ...
    private static void DEBUG_LOG(String msg) {
        if (DEBUG) {
            Log.v("DraggableGridViewPager", msg);
        }
    }
    ...
    public void setDefaultData(int colCount, int rowCount, int gridGap) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            child.measure(View.MeasureSpec.makeMeasureSpec(rect.width(), View.MeasureSpec.EXACTLY),
    ...
    private void animateDragged() {
        if (mLastDragged >= 0) {
            ...
            v.measure(View.MeasureSpec.makeMeasureSpec(r.width(), View.MeasureSpec.EXACTLY),
