    ...
    private void addListener() {
        ...
        temperatureSeekBarLeft.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
               ...
               intent.putExtra("className","com.android.systemui.statusbar.car.TemperatureLeftActivity");
               intent.putExtra("progress",(temperatureSeekBarLeft.getProgress()+16) + "°");
               Log.d("Tuma0419-2","sendBroadcast: "+intent.getAction());
       ...
       airSeekBarLeft.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                Intent intent=new Intent("temperature.left.change");
               intent.putExtra("className","com.android.systemui.statusbar.car.TemperatureLeftActivity");
               intent.putExtra("progress",airSeekBarLeft.getProgress() + "");
               Log.d("Tuma0419-2","sendBroadcast: "+intent.getAction());
               //sendBroadcast(intent);
               sendBroadcastAsUser(intent,UserHandle.ALL);
            }
